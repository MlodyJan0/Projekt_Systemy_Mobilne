package com.example.projekt_jelski.api;
        ...
        import com.example.projekt_jelski.R;
        ...
        import static com.example.projekt_jelski.api.BookDetailsActivity.EXTRA_BOOK_OBJ;
            ...
            public void bind(Book book) {
                if (book != null && checkNullOrEmpty(book.getTitle()) && book.getAuthors() != null) {
                    ...
                    itemContainer.setOnClickListener(v -> {
                        Intent intent = new Intent(com.example.projekt_jelski.api.MainActivityApi.this, BookDetailsActivity.class);
